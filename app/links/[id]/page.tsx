...
import { Loader2, Link as LinkIcon, ChevronRight, ExternalLink, ArrowLeft } from 'lucide-react';
                  ...
                  <div className="bg-white rounded-[12px] shadow-sm border border-[#E5E7EB] p-8 min-h-[500px]">
                    ...
                    <div className="flex justify-center mt-8 pt-4 border-t border-gray-100">
                      <button 
                         onClick={handleSave} 
                         disabled={isSaving}
                         className="px-10 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-black rounded-xl transition-all shadow-lg shadow-emerald-200 flex items-center justify-center min-w-[120px] hover:scale-[1.02] active:scale-[0.98]"
                      >
