    ...
    <div className="flex-1 flex flex-col relative bg-black overflow-hidden">
      ...
      <div className="h-[100px] bg-black border-t border-white/5 px-6 flex items-center justify-between z-[200]">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-3">
          ...
          <button
            onClick={handleLeave}
            className="w-[52px] h-[40px] bg-[#EA4335] hover:bg-[#D93025] flex items-center justify-center rounded-[20px] transition-all ml-2"
          >
    ...
    <div className="flex items-center gap-3">
      <div className="flex flex-col items-center gap-1">
        <button
          ...
          className={`w-[52px] h-[40px] flex items-center justify-center rounded-[20px] transition-all ${isMicrophoneEnabled ? "bg-[#3C4043] text-white" : "bg-[#EA4335] text-white"}`}
        >
      ...
      <div className="flex flex-col items-center gap-1">
        <button
          ...
          className={`w-[52px] h-[40px] flex items-center justify-center rounded-[20px] transition-all ${isCameraEnabled ? "bg-[#3C4043] text-white" : "bg-[#EA4335] text-white"}`}
        >
...
function MeetButton({ icon, label, onClick, active }: any) {
  return (
    <div className="flex flex-col items-center gap-1">
      <button
        onClick={onClick}
        className={`w-[52px] h-[40px] flex items-center justify-center rounded-[20px] transition-all ${active ? "bg-blue-500 text-white" : "bg-[#3C4043] text-white"}`}
      >
        {icon}
      </button>
      <span className="text-[10px] text-slate-400 font-bold uppercase">
...
function TabButton({ icon, onClick, active, badge, isUnread }: any) {
  return (
    <button
      onClick={onClick}
      className={`w-12 h-12 flex items-center justify-center rounded-full transition-all relative ${active ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5"}`}
    >
      {icon}
      {badge && (
        <span className="absolute top-2 right-2 min-w-[16px] h-4 bg-blue-500 text-[10px] font-black text-white px-1 rounded-full border border-black flex items-center justify-center">
          {badge}
        </span>
      )}
      {isUnread && (
        <span className="absolute top-3 right-3 w-2 h-2 bg-[#EA4335] rounded-full border border-black animate-pulse"></span>
      )}
    </button>
  );
}
