...
export default function AssignmentDetailPage() {
  ...
  if (loading) {
    return (
      <MainLayout
        headerTitle={<span className="text-[#6B7280]">Loading...</span>}
      >
      ...
      <MainLayout headerTitle={<span className="text-[#6B7280]">Error</span>}>
        <div className="flex flex-col items-center justify-center min-h-[500px] text-center px-4">
          ...
          <p className="text-gray-500 max-w-md">
            ...
            this assignment through the course page.
          </p>
          <button
            onClick={() => router.push("/")}
            className="mt-6 bg-[#7E22CE] text-white px-6 py-2 rounded-xl font-bold"
          >
            Go Home
          </button>
        </div>
    ...
    return (
      <MainLayout headerTitle={<span className="text-[#6B7280]">Error</span>}>
        <div className="flex flex-col items-center justify-center min-h-[500px] text-center px-4">
          ...
          <p className="text-gray-500 max-w-md">
            We couldn't retrieve the assignment details. The assignment might
            have been deleted or you don't have permission to view it.
          </p>
          <button
            onClick={() => router.back()}
  ...
  const breadcrumbs = (
    <div className="flex items-center text-[14px] font-medium">
      <span
        className="text-[#6B7280] hidden md:inline cursor-pointer"
        onClick={() => router.push("/")}
      >
        Home
      </span>
            ...
            {!isTeacher ? (
              ...
              <>
                ...
                <TabsContent
                  ...
                  className="mt-0 outline-none w-full"
                >
                  <TeacherAssignmentDashboard assignment={assignment} courseId={courseId!} />
                </TabsContent>
              </>
            )}
          </div>
